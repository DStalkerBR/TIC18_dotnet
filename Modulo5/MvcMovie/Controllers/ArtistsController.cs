...
namespace MvcMovie.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        [Authorize (Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("ArtistId,Name,Bio,Photo")] Artist artist)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize (Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("ArtistId,Name,Bio,Photo")] Artist artist)
        {
